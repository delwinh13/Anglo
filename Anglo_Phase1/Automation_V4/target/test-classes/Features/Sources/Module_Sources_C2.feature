...
Feature: Module Sources C2
  ...
  Scenario Outline: Navigate to C2
    ...
    Then I wait for the element to be visible
    And I click the <ModuleC2ID> Button with ID
    ...
    Examples:
      | SourcesID                                    | ModuleC2ID                                   | AddNewBtnID  | ModuleSourcesID                          |
      | section_c07b32b3-2095-4543-a578-367c27a16d16 | section_620a36bc-cc9d-4518-a47f-2b9abdb1638e | btnActAddNew | tab_B6FDEB7C-B09B-46D0-8302-FE1AEFC56742 |
  ...
  Scenario Outline:Module A1 -B4 Enherit (Textbox)
  ...
  Scenario Outline:Module A2 -B4 Enherit (Textbox)
  ...
  Scenario Outline:Module A2 -B4 Enherit  (Numeric Textbox)
  ...
  Scenario Outline:Module A2 -B4 Enherit  (TextArea)
  ...
  Scenario Outline:Module A3 -B4 Enherit (Textbox)
  ...
  Scenario Outline:Module A1 -B4 Enherit  (TextArea)
    ...
    Examples:
      | B4TextAreaDrpdownXpath                                                                                                                       | ExpandB4TextAreaDrpdownXpath                              | B4TextAreaTextboxTagtype | B4TextAreaTextboxText | CloseB4TextAreaTextboxXpath                                                                                                                  | ExpandB4TextAreaTextboxXpath                                                                                                                    | B4TextAreaTextboxValueXpath                                                                                                                                |
      | /html/body/div[1]/div[3]/div/div[2]/div[2]/div[4]/div[7]/div[9]/div[2]/div[2]/div/div/div[9]/div[2]/div[3]/div/div[27]/div[1]/a/span[2]/b[1] | /html/body/div[1]/div[3]/div/div[2]/div[56]/ul[1]/ul/li/i | a                        | Test A3 B4            | /html/body/div[1]/div[3]/div/div[2]/div[2]/div[4]/div[7]/div[9]/div[2]/div[2]/div/div/div[9]/div[2]/div[3]/div/div[31]/div[1]/a/span[2]/b[2] | /html/body/div[1]/div[3]/div/div[2]/div[2]/div[4]/div[7]/div[9]/div[2]/div[2]/div/div/div[9]/div[2]/div[3]/div/div[31]/div[1]/div/ul[1]/ul/li/i | /html/body/div[1]/div[3]/div/div[2]/div[2]/div[4]/div[7]/div[9]/div[2]/div[2]/div/div/div[9]/div[2]/div[3]/div/div[31]/div[1]/div/ul[1]/ul/li/ul/li/a/i[1] |
