...
Launch IsoMetrix Application
    ...
    ${Date}=  Get DateTime
    Set Global Variable  ${Path}  ${EXECDIR}${/}../../Screenshots\\StakeholderEngagementTeamAttendee\\${Date}
...
FR2 - Capture Team Attendees
    Log To Console    Starting FR2 - Capture Team Attendees

    # Attendees tab
    Wait Until Element Is Visible       ${EngagementManagementAttendTab}    40 seconds
    Click Element                       ${EngagementManagementAttendTab}

    # Capture Total number  of attendees that do not exist in system
    #Screenshot    Total non listed attendees

    # Add new Team attendee
    #Wait Until element Is Visible       ${EngagementAddNew}    40 seconds



    wait until element is visible       ${EngagementTeamAttendeeTab}    40 seconds
    Click Element                       ${EngagementTeamAttendeeTab}

    #Sleep    1 seconds
    #Click Element                       ${EngagementAddNew}
    #Add new Team Attendee
    Sleep    5 seconds
    ...
    Sleep    40 seconds
    Wait Until Element Is Visible       ${EngagementTeamAttendProcessID}    40 seconds
...
FR3 - Capture Individual Attendees
    Log To Console    Starting FR3 - Capture Individual Attendees
    ...
    Sleep    20 seconds
    Wait Until Element is Visible       ${EngagementAddNewIndividual}    40 seconds
    Click Element                       ${EngagementAddNewIndividual}

    # Capture Attendee name
    Wait Until Element is Visible       ${EngagementIndividualAttendDrp}    40 seconds
    Click Element                       ${EngagementIndividualAttendDrp}
    Run Keyword  IF  Element  ==  ${EngagementIndividualAttendSearch}  Keyword 1  ELSE IF  Element  ==  ${EngagementIndividualAttendSearch2}  Keyword 2  ELSE  Keyword 3

Keyword 1
    Wait Until element Is Visible       ${EngagementIndividualAttendSearch}    40 seconds
    Click Element                       ${EngagementIndividualAttendSearch}

Keyword 2
    Wait Until element Is Visible       ${EngagementIndividualAttendSearch2}    40 seconds
    Click Element                       ${EngagementIndividualAttendSearch2}

Keyword 3
    Wait Until element Is Visible       ${EngagementIndividualAttendSearch3}    40 seconds
    Click Element                       ${EngagementIndividualAttendSearch3}

    Input Text                          ${EngagementIndividualAttendSearch}    a
    Press Keys                          ${EngagementIndividualAttendSearch}    ENTER
    Sleep    1 seconds
    Wait Until Element is Visible       ${EngagementIndividualAttendAdd}    40 seconds
    Click Element                       ${EngagementIndividualAttendAdd}

    # Click Save
    Wait Until Element Is Visible       ${EngagementIndividualAttendSave}    40 seconds
    Click Element                       ${EngagementIndividualAttendSave}
    Wait Until Element Is Not Visible   ${LoadingBarXpath}    40 seconds

    #Click in line edit
    Sleep     3 seconds
    Wait Until Element Is Visible        ${EngegementIndividualInlineEdit}    40 seconds
    Click Element                        ${EngegementIndividualInlineEdit}


    # Select Individuals Attendee record
    Sleep     3 seconds
    Wait Until Element is Visible       ${EnagementIndividualSelect}    40 seconds
    Click Element                       ${EnagementIndividualSelect}
