...
FR3 - Capture Individual Attendees
    ...
    Sleep    50 seconds
    Wait Until Element Is Visible       ${EngagementIndividualProcessID}    60 seconds
    Click Element                       ${EngagementIndividualProcessID}

    # validate the process is on Edit Phase
    Wait Until Element Is Visible       ${EngagementIndividualProcessEdit}    40 seconds
    Element Should be Visible           ${EngagementIndividualProcessEdit}
    Screenshot    Individual Attendee Add Phase

    #Sleep    3 seconds

    # Close Team attendee
    Wait Until Element Is Visible       ${EngagementIndividualClose}    40 seconds
    Click Element                       ${EngagementIndividualClose}
