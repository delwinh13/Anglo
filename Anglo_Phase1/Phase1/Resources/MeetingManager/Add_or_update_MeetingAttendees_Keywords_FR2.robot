...
Add_or_update_MeetingAttendees_FR2
    ...
    Wait Until Element Is Visible           ${MeetingAttendeesTab}    40 seconds
    Click Element                            ${MeetingAttendeesTab}
    Sleep    2 seconds

    Wait Until Element Is Visible          ${MeetingManagerattendAttendenceDPD1}    40 seconds
    Click Element                          ${MeetingManagerattendAttendenceDPD1}
    Sleep  2 seconds
    Wait Until Element Is Visible         ${MeetingManagerattendAttendenceDPD1present}    40 seconds
    Click Element                         ${MeetingManagerattendAttendenceDPD1present}
    Sleep  2 seconds

    Wait Until Element Is Visible          ${MeetingManagerattendAttendenceDPD2}   40 seconds
    Click Element                          ${MeetingManagerattendAttendenceDPD2}
    Sleep  2 seconds
    Wait Until Element Is Visible         ${MeetingManagerattendAttendenceDPD2present}    40 seconds
    Click Element                          ${MeetingManagerattendAttendenceDPD2present}
    Sleep  2 seconds

    Wait Until Element Is Visible          ${MeetingManagerttendAttendenceDPD3}   40 seconds
    Click Element                          ${MeetingManagerttendAttendenceDPD3}
    Sleep  2 seconds
    Wait Until Element Is Visible         ${MeetingManagerattendAttendenceDPD3present}    40 seconds
    Click Element                         ${MeetingManagerattendAttendenceDPD3present}
    Sleep  2 seconds

    Wait Until Element Is Visible          ${MeetingComments}      40 seconds
    Click Element                           ${MeetingComments}
    Input Text                              ${MeetingComments}      Autotest
    Sleep  2 seconds

    Wait Until Element Is Visible            ${MeetingattendeeAddbttn}    20 seconds
    Click Element                            ${MeetingattendeeAddbttn}
    Sleep    3 seconds

    Wait Until Element IS Visible          ${MeetingManagerAttendeesEmailInput1}     30 seconds
    Click Element                          ${MeetingManagerAttendeesEmailInput1}
    Input Text                             ${MeetingManagerAttendeesEmailInput1}      aaron.adam@angloamerican.com
    Sleep    2 seconds

    Wait Until Element Is Visible           ${MeetingManagerAttendeeName}     30 seconds
    click Element                           ${MeetingManagerAttendeeName}
    Input Text                              ${MeetingManagerAttendeeName}      AAron David Adler
    Sleep    2 seconds

    Wait Until Element Is Visible         ${MeetingManagerAttendeesEmailInput2}    30 seconds
    Click Element                         ${MeetingManagerAttendeesEmailInput2}
    Input text                            ${MeetingManagerAttendeesEmailInput2}    Aaron.david@angloamerican.com
    Sleep    2 seconds
