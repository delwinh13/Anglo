...
Resource    AuditManagement_keywords.robot
...
Add Supplier Audit Management Record
    ...
    Wait Until Element Is Visible        ${AuditManagementBussUnitSrchXpath}    40 seconds
    Sleep    1 seconds
    Input Text                           ${AuditManagementBussUnitSrchXpath}    Base Metals
    Sleep    2 seconds
    ...
    Input Text                           ${AuditManagementTitleXpath}    Testing
    ...
    Input Text                           ${AuditMngProcessSearchXpath}    Process
    ...
    Input Text                           ${AuditMngManagerSearchXpath}    Administrator
...
FR1 - Capture Audit Management Record
    ...
    Log To Console    Starting FR1 Capture Audit Management Record
    Select Frame                         ${iFrame}    
    Sleep     3 seconds
...
FR7 - Conduct an internal or supplier Audit
    ...
    Wait Until Element Is Visible        ${AuditManagementStartBtnID}    40 seconds
    Element Should Be Visible            ${AuditManagementStartBtnID}
...
FR7 - Capture Findings Against Audit
    ...
    Sleep    5 seconds
    Click Element                        ${AuditManagmentContinueBtnID}
    Wait Until Element Is Visible        ${AuitMngQ2DdID}    40 seconds
...
FR7 - Capture Finding Actions
    ...
    Wait Until Element Is Visible        ${AuditActionDueDateXpath}    40 seconds
    Click Element                        ${AuditActionDueDateXpath}
    Input Text                           ${AuditActionDueDateXpath}    ${CurrentDate}
    Sleep    1 seconds
    ...
    Input Text                           ${AuditActionVerificationXpath}    AutoUser
