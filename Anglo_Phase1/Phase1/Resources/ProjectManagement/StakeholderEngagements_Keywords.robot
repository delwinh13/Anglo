...
FR1 - Capture Engagements
    ...
    Sleep    1 seconds
    Input Text                          ${EngagementManagmentProjSrchXpath}    auto test ${CurrentDate}
    Press Keys                          ${EngagementManagmentProjSrchXpath}    ENTER
    Wait Until Element Is Visible       ${EngagementManagementProjSelectAll}    40 seconds
    Sleep    1 seconds
    Click Element                       ${EngagementManagementProjSelectAll}
    Click Element                       ${EngagementManagmentProjectDDID}
